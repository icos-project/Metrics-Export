...
def prepare_results_for_model_input(results, sequence_size):
    ...
    # TODO: review the usage of numpy
...
def call_intelligence_api_model(model_name, data):
    """
    This function will call the intelligence api endpoint that corresponds to the model name passed with the data
    provided.

    :param model_name: The name of the model that will be inferred.
    :param data: The data to pass to the model.

    :return: Response status code and response data as a json.
    """
    url = INTELLIGENCE_API_BASE_URL + model_name
    headers = {
